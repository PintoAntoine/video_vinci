...
fig_final.add_annotation(x="2022-05-01", y=8.94, text="U2 moved from T2 to T1", showarrow=True, font=dict(size=20, color="#DC152A"), bgcolor='#FACACF', arrowcolor='#DC152A')
